...
public class TestNGDependenceonGroupsClass 
{
	...
	@Test(dependsOnMethods="testCaseThree",groups="Smoke Test")
	public void testCaseFive(){
	System.out.println("Im in testCaseFive - And in Smoke Test Group");
	}
